        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-[var(--text-secondary)] max-w-3xl mx-auto">
              Our comprehensive automation platform offers everything you need
              to streamline your business operations and boost productivity.
            </p>
          </div>
            ...
            {features.map((feature, index) => (
              <div key={index} className="feature-card">
                <div className="w-16 h-16 bg-[var(--primary-color)] rounded-lg flex items-center justify-center mb-6">
                  <div
                    className={`icon-${feature.icon} text-2xl text-white`}
                  ></div>
                </div>
